...
LINKEDIN_CLIENT_ID = '86kywez23pb05c'  # todo - fill this field up
LINKEDIN_CLIENT_SECRET = 'QqsVSQIDy5RJSMjn'  # todo - fill this field up
LINKEDIN_REDIRECT_URI = 'https://inahair.com'  # todo - fill this field up
...
if __name__ == '__main__':
    code = generate_authorization_url()
    print(code)